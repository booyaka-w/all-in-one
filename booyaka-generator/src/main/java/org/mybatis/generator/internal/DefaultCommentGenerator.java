...
public class DefaultCommentGenerator implements CommentGenerator {
	...
	public void addGeneralMethodComment(Method method, IntrospectedTable introspectedTable) {
		...
		case "deleteByPrimaryKey":
			method.addJavaDocLine(" * TODO 根据主键删除");
			method.addJavaDocLine(" *  	");
			method.addJavaDocLine(" * @param " + method.getParameters().get(0).getName());
			method.addJavaDocLine(" * @return " + method.getReturnType().get());
			method.addJavaDocLine(" * @throws Exception");
			break;
		case "updateSelectiveByPrimaryKey":
			method.addJavaDocLine(" * TODO 根据对象属性更新");
			method.addJavaDocLine(" *  	");
			method.addJavaDocLine(" * @param " + method.getParameters().get(0).getName());
			method.addJavaDocLine(" * @return " + method.getReturnType().get());
			method.addJavaDocLine(" * @throws Exception");
		...
		case "queryByPrimaryKey":
			...
			break;
		case "querySelective":
			method.addJavaDocLine(" * TODO 根据对象查询");
			method.addJavaDocLine(" *  	");
			method.addJavaDocLine(" * @param " + method.getParameters().get(0).getName());
			method.addJavaDocLine(" * @return " + method.getReturnType().get());
			break;
		case "querySelectiveForPage":
			method.addJavaDocLine(" * 	根据对象分页查询");
			method.addJavaDocLine(" * TODO 根据对象查询");
			method.addJavaDocLine(" *  	");
			method.addJavaDocLine(" * @param " + method.getParameters().get(0).getName());
			method.addJavaDocLine(" * @return " + method.getReturnType().get());
